...
C ---Open Output files---------------------------------------- 
      ...
      OPEN(400,FILE='C:\WaSSICBZB\Outputs\MONTHCARBON.TXT'et :
...
!      OPEN(800,FILE='C:\WaSSICBZB\Outputs\HUCBIO.TXT')    
      ...
      OPEN(910,FILE='C:\WaSSICBZB\Outputs\RUNOFFBYeetANDUSE.TXT')
      OPEN(920,FILE='C:\WaSSICBZB\Outputs\FLOWVOLBYLANDUSE.TXT')    et 
