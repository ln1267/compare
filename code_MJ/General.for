...
C--Open Input files----------------------------------------------
      ...
      OPEN(1,FILE='J:\dell\WaSSICBZB\Inputs\GENERAL.TXT')
      OPEN(2,FILE='J:\dell\WaSSICBZB\Inputs\CELLINFO.TXT') 

      OPEN(4,FILE='J:\dell\WaSSICBZB\Inputs\CLIMATE.TXT')

      OPEN(7,FILE='J:\dell\WaSSICBZB\Inputs\SOILINFO.TXT')
      OPEN(8,FILE='J:\dell\WaSSICBZB\Inputs\LANDLAI.TXT')

      OPEN(11,FILE='J:\dell\WaSSICBZB\Inputs\HUCAREA.TXT')
!      OPEN(22,FILE='J:\dell\WaSSICBZB\Inputs\V_FLOW.TXT')


C ---Open Output files---------------------------------------- 
 
       
      OPEN(77,FILE='J:\dell\WaSSICBZB\Outputs\BASICOUT.TXT')
      
     
      OPEN(78,FILE='J:\dell\WaSSICBZB\Outputs\MONTHFLOW.TXT')
      OPEN(79,FILE='J:\dell\WaSSICBZB\Outputs\ANNUALFLOW.TXT')
      OPEN(80,FILE='J:\dell\WaSSICBZB\Outputs\HUCFLOW.TXT')
      
      OPEN(400,FILE='J:\dell\WaSSICBZB\Outputs\MONTHCARBON.TXT')
      OPEN(500,FILE='J:\dell\WaSSICBZB\Outputs\ANNUALCARBON.TXT')
      OPEN(600,FILE='J:\dell\WaSSICBZB\Outputs\HUCCARBON.TXT')
      OPEN(700,FILE='J:\dell\WaSSICBZB\Outputs\ANNUALBIO.TXT')
!      OPEN(800,FILE='J:\dell\WaSSICBZB\Outputs\HUCBIO.TXT')    
      OPEN(900,FILE='J:\dell\WaSSICBZB\Outputs\SOILSTORAGE.TXT')
      OPEN(910,FILE='J:\dell\WaSSICBZB\Outputs\RUNOFFBYLANDUSE.TXT')
      OPEN(920,FILE='J:\dell\WaSSICBZB\Outputs\FLOWVOLBYLANDUSE.TXT')     
C      OPEN(1000,FILE='J:\dell\WaSSICBZB\Outputs\RUNLAND.TXT')
C --- Open Output FILES (WARMUP.FOR)
!       OPEN(2002,FILE='J:\dell\WaSSICBZB\Outputs\DATA_V_F.TXT') 
!       OPEN(2003,FILE='J:\dell\WaSSICBZB\Outputs\VALIDATION.TXT')  
