...
! VALID
      ...
      COMMON/VALID/ GEP_V(1000,200,12), ET_V(1000,200,12)&
          ...
          BASEFLOW_V(200,12),BASEFLOW(1000,200,12)

! CELLINFO
      REAL LADUSE,LATUDE,LONGI,HUCELE
      INTEGER HUCNO
      COMMON/CELLINFO/LADUSE(1000),HUCNO(1000),LATUDE(1000),LONGI(1000),HUCELE(1000)
...
! BYLAND     
      ...
      COMMON/BYLAND/ RUNLAND(650,40,12,31), &
        ETLAND(650, 40,12,31), GEPLAND(650, 40,12,31)
