VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} 补全多年气象数据 
   Caption         =   "UserForm1"
   ClientHeight    =   3180
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   4710
   OleObjectBlob   =   "补全多年气象数据.frx":0000
   StartUpPosition =   1  '所有者中心
End
Attribute VB_Name = "补全多年气象数据"
...
Sheet2.Cells(1, 1) = "BasinID"
Sheet2.Cells(1, 2) = "YEAR"
Sheet2.Cells(1, 3) = "MONTH"
Sheet2.Cells(1, 4) = "Ppt_mm"
Sheet2.Cells(1, 5) = "Tavg_C"
    ...
    For j = 1 To 12
        For h = HUC_start To HUC_num
            ...
            If (Sheet1.Cells(a, 1) = h) Then
                ...
                Sheet2.Cells(b, 5) = Sheet1.Cells(a, 5) * 0.1
                a = a + 1
            ...
            Else
                ...
                Sheet2.Cells(b, 2) = i
                Sheet2.Cells(b, 3) = j
                Sheet2.Cells(b, 4) = Sheet2.Cells(b - 1, 4)
                Sheet2.Cells(b, 5) = Sheet2.Cells(b - 1, 5)
            End If
            b = b + 1
        Next h
    Next j
