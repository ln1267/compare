...
C**********************************************************************C
     ...
     &LAI_18(4000,200,12), LAI_19(4000,200,12)
      ...
      INTEGER NLC, HUCNO(4000), M
      
      INTEGER BYEAR
      
      INTEGER MONTHD(12),MONTHL(12), MJD(12), MMD
      
      REAL DEGLAT, LATUDE(4000), PET(200, 12, 20)
 
      REAL APET(12), PE, LADUSE(4000,20), TEMP(4000,200,12)
      
      REAL TPET, RAIN(4000,200,12), AAPPT(4000) 
      ...
      REAL LAI_16(4000,200,12) 
      REAL LAI_17(4000,200,12)
      REAL LAI_18(4000,200,12)
      REAL LAI_19(4000,200,12)      
      
      
      REAL LAI, PAET(200,12,20), TPAET, APAET(12)
...
C ----ASSIGN LAI FOR EACH LAND USE
             ...
             IF (K.EQ.1) THEN
                ...
                LAI = LAI_1(I,BYEAR-1960+J,M)
             
             ELSEIF (K.EQ.2) THEN
             
                LAI = LAI_2(I,BYEAR-1960+J,M)
             
             ELSEIF (K.EQ.3) THEN
             
                LAI = LAI_3(I,BYEAR-1960+J,M)
             
             ELSEIF (K.EQ.4) THEN
             
                LAI = LAI_4(I,BYEAR-1960+J,M)
             
             ELSEIF (K.EQ.5) THEN
             
                LAI = LAI_5(I,BYEAR-1960+J,M)
             
             ELSEIF (K.EQ.6) THEN
             
                          
                LAI = LAI_6(I,BYEAR-1960+J,M)
             
             ELSEIF (K.EQ.7) THEN
             
                LAI = LAI_7(I,BYEAR-1960+J,M)
             
             ELSEIF (K.EQ.8) THEN
             
                LAI = LAI_8(I,BYEAR-1960+J,M)
                                
             ELSEIF (K.EQ.9) THEN
             
                LAI = LAI_9(I,BYEAR-1960+J,M)
             
             ELSEIF (K.EQ.10) THEN
             
                LAI = LAI_10(I,BYEAR-1960+J,M)
             
             ELSEIF (K.EQ.11) THEN
             
                LAI = LAI_11(I,BYEAR-1960+J,M)
             
             ELSEIF (K.EQ.12) THEN
             
                LAI = LAI_12(I,BYEAR-1960+J,M)
             
             ELSEIF (K.EQ.13) THEN
             
                LAI = LAI_13(I,BYEAR-1960+J,M)
             
             ELSEIF (K.EQ. 14) THEN
             
                LAI = LAI_14(I,BYEAR-1960+J,M)
             
             ELSEIF (K.EQ. 15) THEN
             
                LAI = LAI_15(I,BYEAR-1960+J,M)

             ELSEIF (K.EQ. 16) THEN
             
                LAI = LAI_16(I,BYEAR-1960+J,M)
             
             ELSEIF (K.EQ. 17) THEN
             
                LAI = LAI_17(I,BYEAR-1960+J,M)
             
             ELSEIF (K.EQ. 18) THEN
             
                LAI = LAI_18(I,BYEAR-1960+J,M)
             
             ELSEIF (K.EQ. 19) THEN
             
                LAI = LAI_19(I,BYEAR-1960+J,M)
