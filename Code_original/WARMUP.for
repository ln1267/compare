...
c      COMMON/GROUNDWATER/ GROUNDWATER(2200,9), ALAFA
...
C**********************************************************************C
     ...
     >  REXP(2200), PFREE(2200), SMC(12)
      ...
      INTEGER HUCNO(4000), NLC

      REAL  LATUDE(4000),LONGI(4000), LADUSE(4000,20)
...
c      COMMON/POPULATION/POPULATION(2200, 150)      
c      COMMON/HUCREGION/DMC(18,4),IRRC(18,4), PPC(18,4) 
c      COMMON/RETURNFLOW/ RETURNFLOW(2200,8)
c      COMMON/GROUNDWATER/ GROUNDWATER(2200,9), ALAFA      
c      COMMON/WATERUSE/ WATERUSE(2200,8), HUCWUSE(2200)

      COMMON/HUC/ HUCAREA(2200)      
      
c      COMMON/ELEVATION/HUCELE(2200)
      
c      COMMON/FLOWNETWORK/IDFHUC(2200), FHUC(2200), IDTHUC(2200), 
c     &THUC(2200)
     
c      COMMON/NODE/NONODE
          
c      COMMON/ROUTING/RECHUC(2200,50),NORECHUC(2200)
      
c      COMMON/IRRIGATION/DRIRR
      
c      REAL  POPULATION(2200,150)                   
c      REAL HUCAREA(2200), RETURNFLOW(2200,8), WATERUSE(2200, 8) 
c      REAL GROUNDWATER (2200, 9), HUCWUSE(2200)
...
c      INTEGER IDFHUC(2200), FHUC(2200), IDTHUC(2200), THUC(2200)
      
c      INTEGER K,RECHUC(2200, 50)
      
c      INTEGER NORECHUC(2200), POP_FLAG 
...
C**********************************************************************C
     ...
     &LAI_18(4000,200,12), LAI_19(4000,200,12)
      ...
      REAL LAI_1(4000,200,12)
      REAL LAI_2(4000,200,12)
      REAL LAI_3(4000,200,12)
      REAL LAI_4(4000,200,12)
      REAL LAI_5(4000,200,12)
      REAL LAI_6(4000,200,12)
      REAL LAI_7(4000,200,12)
      REAL LAI_8(4000,200,12)
 
            
      REAL LAI_9(4000,200,12)
      REAL LAI_10(4000,200,12)
      REAL LAI_11(4000,200,12)
      REAL LAI_12(4000,200,12)
      REAL LAI_13(4000,200,12)
      REAL LAI_14(4000,200,12)
      REAL LAI_15(4000,200,12)
...
C --- J=47 => YEAR 2006 (LAST YEAR OF LAI DATA)
            ...
            IF (I .EQ. 1 .AND. J .EQ. 41 .AND. M .EQ. 1) THEN 
...
C--- ASSIGN YEAR 2002 LAI DATA TO YEARS AFTER 2002
      ...
      DO 203 I=1, NGRID
         ...
         DO 303 J=48, 50
            ...
            LAI_1(I,J,M) = LAI_1(I,47,M)
            LAI_2(I,J,M) = LAI_2(I,47,M)
            LAI_3(I,J,M) = LAI_3(I,47,M)
            LAI_4(I,J,M) = LAI_4(I,47,M) *(1.0-FPERDLAI)
            LAI_5(I,J,M) = LAI_5(I,47,M) *(1.0-FPERDLAI)
            LAI_6(I,J,M) = LAI_6(I,47,M) *(1.0-FPERDLAI)
            LAI_7(I,J,M) = LAI_7(I,47,M) *(1.0-FPERDLAI)
            LAI_8(I,J,M) = LAI_8(I,47,M) *(1.0-FPERDLAI) 
            
            LAI_9(I,J,M) = LAI_9(I,47,M)
            LAI_10(I,J,M) = LAI_10(I,47,M)
            LAI_11(I,J,M) = LAI_11(I,47,M)*(1.0-FPERDLAI)
            LAI_12(I,J,M) = LAI_12(I,47,M)
            LAI_13(I,J,M) = LAI_13(I,47,M)
            LAI_14(I,J,M) = LAI_14(I,47,M)
            LAI_15(I,J,M) = LAI_15(I,47,M)
...
C**********************************************************************C
      ...
      REAL RAIN(4000,200,12), TEMP(4000,200,12), ANNPPT(4000,200)
      
      REAL SUMANPPT(4000), AAPPT(4000)
...
C910            FORMAT  (/'CLIMATE DATA', 10A10)
               ...
               READ(4,*) HUCNO(I), YEAR, M, RAIN(I,J,M), TEMP(I,J,M)
