...
C**********************************************************************C
     ...
     >  REXP(2200), PFREE(2200), SMC(12)
      ...
      COMMON/CELLINFO/LADUSE(4000,10),HUCNO(4000),
...
C -----------------------------------------------------------------------------     
      ...
      REAL LADUSE(4000,20),RAIN(4000,200,12), APET(12), AET(12),
     > PAET(200, 12,20), INTER(12), SMC(12),STRFLOW(2200, 200, 12),
     > APAET(12)
     
      REAL RUNOFF(12), PRIBF(12), SECBF(12), INTF(12)
     
      REAL TANURAIN, TANUPET,TANUAET,TANURUN

      REAL ANURAIN(200),ANUPET(200),ANUAET(200), ANURUN(200)
...
c      REAL TDM, TSP
      ...
      INTEGER HUCNO(4000), BYEAR, IDY, ISNOWP
      REAL TRUNOFF
      
      REAL RAINSQ, F, RFACTOR(200)
