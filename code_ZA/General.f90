...
! BYLAND ok    
      ...
      COMMON/BYLAND/ RUNLAND(50,200,12,31,10), &
        ETLAND(50, 200,12,31,10), GEPLAND(50, 200,12,31,10),NEELAND(50,200,12, 31,10) 
...
!--Open Input files----------------------------------------------
      ...
      OPEN(1,FILE='D:\YUN\Baidu_sina\WASSICBZB\Inputs_new\GENERAL.TXT')
      OPEN(2,FILE='D:\YUN\Baidu_sina\WASSICBZB\Inputs_new\CELLINFO.TXT') 

      OPEN(4,FILE='D:\YUN\Baidu_sina\WASSICBZB\Inputs_new\CLIMATE0.TXT')

      OPEN(7,FILE='D:\YUN\Baidu_sina\WASSICBZB\Inputs_new\SOILINFO.TXT')
      OPEN(8,FILE='D:\YUN\Baidu_sina\WASSICBZB\Inputs_new\LANDLAI.TXT')

      OPEN(11,FILE='D:\YUN\Baidu_sina\WASSICBZB\Inputs_new\HUCAREA.TXT')
      OPEN(22,FILE='D:\YUN\Baidu_sina\WASSICBZB\Inputs_new\V_FLOW.TXT')


! ---Open Output files---------------------------------------- 
 
       
      OPEN(77,FILE='D:\YUN\Baidu_sina\WASSICBZB\outputs_2\BASICOUT.TXT')
      
     
      OPEN(78,FILE='D:\YUN\Baidu_sina\WASSICBZB\outputs_2\MONTHFLOW.TXT')
      OPEN(79,FILE='D:\YUN\Baidu_sina\WASSICBZB\outputs_2\ANNUALFLOW.TXT')
      OPEN(80,FILE='D:\YUN\Baidu_sina\WASSICBZB\outputs_2\HUCFLOW.TXT')
      OPEN(99,FILE='D:\YUN\Baidu_sina\WASSICBZB\outputs_2\ceshi.TXT')
      OPEN(400,FILE='D:\YUN\Baidu_sina\WASSICBZB\outputs_2\MONTHCARBON.TXT')
      OPEN(500,FILE='D:\YUN\Baidu_sina\WASSICBZB\outputs_2\ANNUALCARBON.TXT')
      OPEN(600,FILE='D:\YUN\Baidu_sina\WASSICBZB\outputs_2\HUCCARBON.TXT')
      OPEN(700,FILE='D:\YUN\Baidu_sina\WASSICBZB\outputs_2\ANNUALBIO.TXT')
      OPEN(800,FILE='D:\YUN\Baidu_sina\WASSICBZB\outputs_2\HUCBIO.TXT')    
      OPEN(900,FILE='D:\YUN\Baidu_sina\WASSICBZB\outputs_2\SOILSTORAGE.TXT')
      OPEN(910,FILE='D:\YUN\Baidu_sina\WASSICBZB\outputs_2\RUNOFFBYLANDUSE.TXT')
      OPEN(920,FILE='D:\YUN\Baidu_sina\WASSICBZB\outputs_2\FLOWVOLBYLANDUSE.TXT')     
      OPEN(930,FILE='D:\YUN\Baidu_sina\WASSICBZB\outputs_2\RUNOFFBYLANDUSE_m.TXT')
      OPEN(940,FILE='D:\YUN\Baidu_sina\WASSICBZB\outputs_2\FLOWVOLBYLANDUSE_m.TXT')
        
!      OPEN(1000,FILE='D:\YUN\Baidu_sina\WASSICBZB\Outputs\RUNLAND.TXT')
! --- READ INPUT DATA FILES (WARMUP.FOR)
       OPEN(2002,FILE='D:\YUN\Baidu_sina\WASSICBZB\outputs_2\DATA_V_F.TXT') 
       OPEN(2003,FILE='D:\YUN\Baidu_sina\WASSICBZB\outputs_2\VALIDATION.TXT')  
